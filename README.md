...
| 사례 | 공개 증빙 | 핵심 내용 |
| --- | --- | --- |
| [Dailyting faststart](case-studies/dailyting-faststart.md) | [서비스](https://dailyting.cloud) · [YEON Blog 기술 노트](https://blog.yeon.world/engineering/dailyting-video-faststart) | mp4 `moov` atom 배치를 바꿔 재생 전 선행 다운로드를 구조적으로 줄인 사례 |
